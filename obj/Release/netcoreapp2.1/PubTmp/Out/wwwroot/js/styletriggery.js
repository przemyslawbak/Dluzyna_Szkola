$(document).ready(function () {
    ...
    //kolory
    $(".c-grid-title, .c-event-title, .c-event-over, .c-event, .c-today, .c-week-day, .przycisk, .p5edziennik, .hyperPaging, a span, .tytulAdmin, .stronaPaging, .dalejDetails, .stopa, actionLink:link, actionLink:visited, actionLink:active, .nazwiskoOsoby, .dodatkiButton, .dropdown div, .gotit-btn").css("color", tekstnaglowkow); //tresctlo
